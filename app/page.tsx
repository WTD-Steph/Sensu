...
// Next/Image doesn't process SVG without dangerouslyAllowSVG. Plain <img>
// is correct for our hand-authored SVG logos.
/* eslint-disable @next/next/no-img-element */

/**
 * Phase 0 home page — direct port of the current static index.html into a
 * Next.js Server Component using Tailwind + brand tokens. Visual parity is
 * the goal here so the live URL doesn't break during the rebuild. Phase 1+
 * will componentize and replace sections with the real design.
 */
export default function HomePage() {
  return (
    <>
      <header className="sticky top-0 z-50 border-b border-black/10 bg-whim/85 backdrop-blur supports-[backdrop-filter]:bg-whim/70">
        <div className="mx-auto flex h-[72px] max-w-page items-center gap-7 px-gutter">
          <Link href="#top" aria-label="Sensu home">
            <img
          ...
          >
            <a className="opacity-80 hover:opacity-100" href="#story">Story</a>
            <a className="opacity-80 hover:opacity-100" href="#collections">Collections</a>
            <a className="opacity-80 hover:opacity-100" href="#products">Featured</a>
            <a className="opacity-80 hover:opacity-100" href="#ritual">Ritual</a>
            <a className="opacity-80 hover:opacity-100" href="#visit">Follow</a>
          </nav>
          <a
            href={SHOPEE_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="ml-auto rounded-full bg-void px-5 py-3 text-[13.5px] font-medium uppercase tracking-[0.06em] text-whim transition-colors duration-200 ease-sensu hover:bg-marble"
          >
            Shop the line
          </a>
        </div>
      ...
      <main id="main" className="overflow-x-hidden">
        ...
        {/* COLLECTIONS / STORY / FEATURED placeholder anchor sections — Phase 1+ rebuilds these */}
        ...
        <section id="collections" className="py-section bg-whim">
          <div className="mx-auto max-w-page px-gutter">
            ...
            <p className="max-w-[58ch] text-body-lg text-void/70">
              Phase 1 rebuilds this section with motif-per-card visuals and
        ...
        <section id="ritual" className="bg-marble py-section text-whim">
            ...
            <ul className="border-t border-black/10">
              <li className="grid grid-cols-[120px_1fr] gap-6 border-b border-black/10 py-5">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="border-b border-current self-start hover:text-marble"
                >
                  @madebysensu
                </a>
              </li>
      ...
      <footer className="bg-void py-16 text-whim">
        <div className="mx-auto grid max-w-page grid-cols-1 items-start gap-9 px-gutter md:grid-cols-[1.4fr_1fr_1fr]">
          <div>
            <img
              src="/logo/sensu-mark-dark.svg"
              alt="Sensu — sense, written in Braille"
              className="mb-4 h-9 w-auto invert"
            />
            <p className="text-[17px] tracking-[0.04em]">Sensu · センス</p>
            <p className="mt-1 text-sm text-whim/60">
              Japanese-inspired drinkware, made for the modern hand.
            </p>
            <p className="mt-1 text-sm text-whim/60">
          ...
          <nav aria-label="Footer" className="flex flex-col gap-2.5">
            <h4 className="mb-1 text-caption uppercase tracking-eyebrow text-whim/60">
              Discover
            </h4>
            <a className="opacity-85 hover:opacity-100" href="#story">Our story</a>
            <a className="opacity-85 hover:opacity-100" href="#collections">Collections</a>
            <a className="opacity-85 hover:opacity-100" href="#products">Featured pieces</a>
          </nav>
          <nav aria-label="Connect" className="flex flex-col gap-2.5">
            <h4 className="mb-1 text-caption uppercase tracking-eyebrow text-whim/60">
              Follow
            </h4>
            <a className="opacity-85 hover:opacity-100" href={IG_URL} target="_blank" rel="noopener noreferrer">
              Instagram
            </a>
            <a className="opacity-85 hover:opacity-100" href="#visit">
              #SensuCircle
            </a>
          </nav>
        </div>
